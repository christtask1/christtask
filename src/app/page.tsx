    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <nav className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <Link 
            href="/login"
            className="bg-white dark:bg-gray-800 text-gray-800 dark:text-white px-4 py-2 rounded-lg font-semibold hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-300 border border-gray-300 dark:border-gray-600"
          >
            Login
          </Link>
        </div>
