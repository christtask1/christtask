  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4" data-page="newsletter">
      <div className="text-center max-w-4xl newsletter-content">
        ...
        <div className="paragraph-exact">
          <div>Join my private email list and get the unfiltered, tactical</div>
          <div>breakdowns on ecom, AI, making money online, and what's</div>
          <div>actually working right now. No fluff. No fake screenshots. Just</div>
          <div>real sh*t that makes you money.</div>
        </div>
