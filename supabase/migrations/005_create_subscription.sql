-- Create a subscription via Stripe wrapper and return the invoice payment_intent client_secret
...
GRANT EXECUTE ON FUNCTION public.create_subscription(TEXT, TEXT, TEXT) TO authenticated;
